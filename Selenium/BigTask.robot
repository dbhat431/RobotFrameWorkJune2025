...
Verify login success with valid credentials
        ...
        Input Text    xpath://textarea[@id='ta1']    Hi this is Dhrithi Bhat        timeout=5
        Sleep    4s
...
#        Sleep    1
        ...
        Sleep    1
        Input Text    css:div[id='HTML11'] textarea    This is Dhrithi
        Sleep    2
        ...
        Sleep    2s
        Input Text    xpath://form[@name='form1']//input[@type='text']    dhrithii13
        Sleep    2s
        Input Text    xpath://form[@name='form1']//input[@type='password']    dhrithi123
        Sleep    2s
        Click Element    xpath://button[normalize-space()='LogIn']


#Search the blog
         Input Text    xpath://input[@name='q']    dhrithi123
         Sleep    2s
...
#Simple login
        Input Text    xpath://input[@name='userid']    Dhrithi
        Sleep    1s
        Input Text    xpath://input[@name='pswrd']    dhrithi123
        Sleep    1s
